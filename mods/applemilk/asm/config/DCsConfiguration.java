...
public class DCsConfiguration
{
    ...
    private static DCsConfiguration PARENT = null;

    File file;

    private Map<String, ConfigCategoryDC> categories = new TreeMap<String, ConfigCategoryDC>();
    private Map<String, DCsConfiguration> children = new TreeMap<String, DCsConfiguration>();
     ...
     */
    public DCsConfiguration(File file)
    {
        this.file = file;
    ...
    public DCsConfiguration(File file, boolean caseSensitiveCustomCategories)
    {
        this(file);
            ...
            if (file.canRead())
            {
                ...
                while (true)
                {
                    ...
                    else if (end.matches())
                    {
                        ...
                        DCsConfiguration child = new DCsConfiguration();
    ...
    public void save()
    {
        ...
        try
        {
            ...
            if (file.canWrite())
            {
                ...
                {
                    for (Map.Entry<String, DCsConfiguration> entry : children.entrySet())
                    {
    ...
    private void setChild(String name, DCsConfiguration child)
    {
        ...
        {
            DCsConfiguration old = children.get(name);
    ...
    {
        PARENT = new DCsConfiguration(new File(Loader.instance().getConfigDir(), "global.cfg"));
        PARENT.load();
    }
    ...
    public boolean hasChanged()
    {
        ...
        for (DCsConfiguration child : children.values())
        {
