...
public class TileMakerNext extends TileEntity
{
    ...
    private String tex = "/mods/applemilk/textures/blocks/contents_water.png";
    private String tex_milk = "/mods/applemilk/textures/blocks/contents_water.png";
    ...
    public void setTexture(ItemStack input)
    {
    	if (input != null)
    	{
        	...
        	{
        		this.tex = "/mods/applemilk/textures/blocks/contents_water.png";
        		this.tex_milk = "/mods/applemilk/textures/blocks/contents_water.png";
        	}
    	}
    	else
    	{
