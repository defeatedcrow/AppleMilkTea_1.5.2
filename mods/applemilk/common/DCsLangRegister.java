...
public class DCsLangRegister {
	...
	public void registerLang()
	{
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.appleTart, 1, 0), "Apple Tart");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.appleTart, 1, 0), "ja_JP", "りんごのタルト");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.appleTart, 1, 1), "Cassis Tart");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.appleTart, 1, 1), "ja_JP", "カシスのタルト");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 0), "Condensed Milk");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 0), "ja_JP", "加糖練乳");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 1), "Cassis Preserve");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 1), "ja_JP", "カシスジャム");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 2), "Sweet Mint Sauce");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 2), "ja_JP", "ミントジャム");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.appleSandwich, 1, 2), "Cassis Sandwich");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.appleSandwich, 1, 2), "ja_JP", "カシスジャムサンド");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.icyToffyApple, 1, 4), "Cassis Candy");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.icyToffyApple, 1, 4), "ja_JP", "カシス飴");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.icyToffyApple, 1, 5), "Mint Candy");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.icyToffyApple, 1, 5), "ja_JP", "ハッカ飴");
		
		
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 0), "Oak Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 0), "ja_JP", "樫の丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 1), "Spruse Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 1), "ja_JP", "松の丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 2), "Birch Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 2), "ja_JP", "白樺の丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 3), "Jangle Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 3), "ja_JP", "ジャングルの丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 4), "Rubberwood Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 4), "ja_JP", "ゴムの木の丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 5), "Greatwood Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 5), "ja_JP", "グレートウッドの丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 6), "Silverwood Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 6), "ja_JP", "シルバーウッドの丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 7), "Forcewood Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 7), "ja_JP", "フォースウッドの丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 8), "Cherry Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 8), "ja_JP", "桜の丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 9), "Momizi Log Box");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.woodBox, 1, 9), "ja_JP", "モミジの丸太箱");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.woodBox, 1, 10), "JP Ceder Log Box");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.melonBomb, 1, 0), "Compressed Melon");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.wipeBox,1,1), "KimWipes");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.wipeBox,1,3), "Opened KimWipes");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.wipeBox,1,3), "ja_JP", "開封済みキムワイプ");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.wipeBox,1,4), "Infinity KimWipes");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.filledPan, 1, 3), "Zosui (Soup Rice)");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.filledPan, 1, 3), "ja_JP", "とりたま雑炊鍋");
		
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.filledPan2, 1, 0), "Kayakumeshi (Variety Mixed Rice)");
		...
		LanguageRegistry.addName(DCsAppleMilk.cropMint, "Mint Crop");
		LanguageRegistry.instance().addNameForObject(DCsAppleMilk.cropMint, "ja_JP", "ミントの苗");
		
		LanguageRegistry.addName(DCsAppleMilk.itemMintSeed, "Mint Seeds");
		LanguageRegistry.instance().addNameForObject(DCsAppleMilk.itemMintSeed, "ja_JP", "ミントの種");
		
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.saplingTea, 1 ,0), "Tea Sapling");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.saplingTea, 1, 0), "ja_JP", "茶の苗");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.saplingTea, 1 ,1), "Cassis Sapling");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.saplingTea, 1, 1), "ja_JP", "カシスの苗");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.saplingTea, 1 ,2), "Camellia Sapling");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.saplingTea, 1, 2), "ja_JP", "山茶花の苗");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 0), "Cassis Tree");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 0), "ja_JP", "カシスの木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 1), "Grown Cassis Tree");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 1), "ja_JP", "成長したカシスの木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 2), "Cassis Flowers");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 2), "ja_JP", "花の咲いたカシスの木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 3), "Cassis Fruits");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 3), "ja_JP", "実ったカシスの木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 4), "Camellia Tree");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 4), "ja_JP", "山茶花の木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 5), "Grown Camellia Tree");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 5), "ja_JP", "成長した山茶花の木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 6), "Camellia Buds");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 6), "ja_JP", "蕾のある山茶花の木");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cassisTree, 1 , 7), "Camellia Flowers");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cassisTree, 1, 7), "ja_JP", "花の咲いた山茶花の木");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.leafTea, 1, 2), "Cassis Fruits");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.leafTea, 1, 2), "ja_JP", "カシスの実");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.blockIcecream, 1, 10), "Mint Icecream");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.blockIcecream, 1, 10), "ja_JP", "ミントシャーベット");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cocktail, 1, 10), "Kir");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cocktail, 1, 10), "ja_JP", "キール");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cocktail, 1, 11), "Cassis Milk");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cocktail, 1, 11), "ja_JP", "カシスミルク");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cocktail, 1, 12), "Bloody Mary");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cocktail, 1, 12), "ja_JP", "ブラッディ・メアリー");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cocktail, 1, 13), "Cassis Tea Cocktail");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cocktail, 1, 13), "ja_JP", "カシスティー");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cocktail, 1, 14), "Double Apple");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cocktail, 1, 14), "ja_JP", "ダブルアップル");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.cocktail, 1, 15), "Plum & Soymilk");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.cocktail, 1, 15), "ja_JP", "梅酒豆乳");
		
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 0), "Sake");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 0), "ja_JP", "日本酒");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 1), "Beer");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 1), "ja_JP", "ビール");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 2), "Wine");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 2), "ja_JP", "ワイン");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 3), "Rum");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 3), "ja_JP", "ラム酒");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 4), "Gin");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 4), "ja_JP", "ジン");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 5), "Vodka");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 5), "ja_JP", "ウォッカ");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 6), "Whiskey");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 6), "ja_JP", "ウィスキー");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 7), "Apple Liquor");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 7), "ja_JP", "りんご酒");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 8), "Tea Liquor");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 8), "ja_JP", "紅茶酒");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 9), "Cassis Liquor");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 9), "ja_JP", "カシス酒");
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.alcoholCup, 1, 10), "Plum Liquor");
		LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.alcoholCup, 1, 10), "ja_JP", "梅酒");
		...
		LanguageRegistry.addName(new ItemStack(DCsAppleMilk.chalcedony, 1, 4), "Porcelain Block");
		LanguageRegistry.instance().addNameForObject((new ItemStack(DCsAppleMilk.chalcedony, 1, 4)), "ja_JP", "白磁ブロック");
		...
		LanguageRegistry.instance().addStringLocalization("DCs.potion.protectionExplode", "Explodion Protection");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.protectionExplode", "ja_JP", "爆発無効");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.protectionProjectile", "Projectile Protection");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.protectionProjectile", "ja_JP", "射撃無効");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.reflex", "Reflex");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.reflex", "ja_JP", "反射");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.absorptionEXP", "EXP Absorption");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.absorptionEXP", "ja_JP", "EXP吸収");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.absorptionHeal", "Damage Absorption");
		LanguageRegistry.instance().addStringLocalization("DCs.potion.absorptionHeal", "ja_JP", "ダメージ吸収");
		...
		for (int i = 0 ; i < 4 ; i++)
		{
			...
			LanguageRegistry.addName(new ItemStack(DCsAppleMilk.itemCordial, 1, i+4), "Tea Liquor Bottle");
			LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.itemCordial, 1, i+4), "ja_JP", "紅茶酒ボトル");
			LanguageRegistry.addName(new ItemStack(DCsAppleMilk.itemCordial, 1, i+8), "Cassis Liquor Bottle");
			LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.itemCordial, 1, i+8), "ja_JP", "カシス酒ボトル");
			LanguageRegistry.addName(new ItemStack(DCsAppleMilk.itemCordial, 1, i+12), "Plum Liquor Bottle");
			LanguageRegistry.instance().addNameForObject(new ItemStack(DCsAppleMilk.itemCordial, 1, i+12), "ja_JP", "梅酒ボトル");
		}
