...
public class DCsAppleMilk{
	...
	public static boolean SuccessLoadForestry = false;
	...
	public static final String[] TEX_PASS_ENTITY = new String[] {
		"/mods/applemilk/textures/entity/",
		"/mods/applemilk/textures/entity/x32/",
		"/mods/applemilk/textures/entity/x32alt/"
	};
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		//Material
		//ツール属性の内容を登録する
		enumToolMaterialChalcedony = EnumHelper.addToolMaterial("CHALCEDONY", 2, 128, 5.0F, 2, 18);
    ...
    public void postInit(FMLPostInitializationEvent event) {
	    ...
	    if (Loader.isModLoaded("Forestry"))
	    {
	    	...
	    	try
	        {
	          this.SuccessLoadForestry = true;
	          (new LoadForestryHandler()).load();
	    ...
	    if (Loader.isModLoaded("mod_Bamboo"))
	    {
