...
public class DCsRecipeRegister {
	    ...
	    if (!DCsAppleMilk.getServerPlop1)
	    {
	    	GameRegistry.addRecipe(
	 			...
	 			new Object[]{
	 					 ...
	 					 "ZYZ",
	 					 "XWX",
	 					 Character.valueOf('X'), new ItemStack(DCsAppleMilk.chalcedony, 1, 4),
		 ...
		 GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{
						 "ZYZ",
						 "ZXZ",
						 Character.valueOf('Z'), new ItemStack(DCsAppleMilk.chalcedony, 1, 4),
	...
	static void addSmelting() {
		...
		GameRegistry.addSmelting(
	      ...
	      //EXレシピ。1.5には堅焼き粘土が無いため、白磁ブロックで代用する。
	      FurnaceRecipes.smelting().addSmelting(DCsAppleMilk.gunpowderContainer.blockID, 2,
	    		  new ItemStack(DCsAppleMilk.chalcedony, 3, 4), 0.3F);
	}
