...
public class ItemChalcedonyKnife extends ItemTool{
	...
	public ItemChalcedonyKnife (int par1, EnumToolMaterial par2){
		super (par1, 3, par2, blocksEffectiveAgainst);
		this.setMaxStackSize(1);
	}
	
	public boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World, int par3, int par4, int par5, int par6, EntityLiving par7EntityLivingBase)
    {
