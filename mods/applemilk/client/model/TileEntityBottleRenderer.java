...
{
    private static String bottleTex = new String("/mods/applemilk/textures/entity/largebottle.png");
    private static String glassTex = new String("/mods/applemilk/textures/blocks/blueglass.png");
    private static String contentsTex = new String("/mods/applemilk/textures/blocks/contents_milk.png");
    ...
    public void setRotation(TileLargeBottle par0Tile, float par1, float par2, float par3)
    {
        ...
        if (l < 8) {
            ...
            bottleTex = new String(texPass);
            this.bindTextureByName(bottleTex);
            GL11.glPushMatrix();
            ...
            this.bindTextureByName(glassTex);
        	GL11.glPushMatrix();
            GL11.glEnable(GL12.GL_RESCALE_NORMAL);
            GL11.glEnable(GL11.GL_BLEND);
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
